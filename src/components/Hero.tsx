...
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, type FC, type ReactNode, useState } from "react";
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <CanvasWrapper>
      <group rotation={[degToRad(0), degToRad(rotation), degToRad(-90)]}>
        <PlaneNoise ref={meshRef} material={beamMaterial} width={beamWidth} count={beamNumber} height={beamHeight} />
        <DirLight position={[-1, 0, 0]} color={lightColor} />
      </group>
    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 pt-20">
        <div className="mx-auto max-w-5xl text-center">
          {/* Brand label */}
          <p className="text-sm tracking-[0.3em] uppercase text-primary font-semibold mb-8 animate-fade-in">
            EdgeCrafts
          </p>

          {/* Main headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-[-0.02em] mb-12 text-foreground animate-fade-in">
