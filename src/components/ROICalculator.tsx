...
export const ROICalculator = () => {
  ...
  const CALL_TO_APPOINTMENT_RATE = 0.35; // 35% of answered calls become appointments
  const VISIT_TO_LEAD_RATE = 0.03; // 3% of site visitors become leads
  const LEAD_TO_CUSTOMER_RATE = 0.25; // 25% of leads become customers
  const AVG_CUSTOMER_VALUE = 500; // Average customer value in dollars
  const AI_RECOVERY_RATE = 0.80; // 80% of missed calls/leads recovered by AI
